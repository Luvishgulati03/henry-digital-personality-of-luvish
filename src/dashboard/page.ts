...
<div class="card span-4"><div class="card-head"><h2>dispatch</h2><span class="label">Luna / specialist</span></div><select id="role"><option>architect</option><option>runtime</option><option>memory</option><option>dashboard</option><option>gmail</option><option>pr-review</option><option>job-application</option><option>qa</option></select><input class="input" id="task" placeholder="Task for the specialist"><button class="button primary" onclick="dispatch()">dispatch</button><pre id="dispatchResult"></pre></div>
